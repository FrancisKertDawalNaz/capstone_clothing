        ...
        <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    ...
                    <div class="row align-items-center mb-5">
                        <div class="col-md-6 text-center">
                            <img src="{{ asset('img/girl1.jpg') }}" class="img-fluid rounded" alt="Slide Three">
                        </div>
                        <div class="col-md-6">
            ...
            <div class="row text-center justify-content-center g-4">
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card border-0 shadow-sm h-100">
                        <img src="{{ asset('img/ladies.jpg') }}" class="card-img-top rounded-top" alt="Ladies">
                        <div class="card-body">
                            <h6 class="fw-semibold mb-3">Ladies</h6>
                            <a href="{{ route('user.ladies') }}" class="btn btn-dark btn-sm px-4">View</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card border-0 shadow-sm h-100">
                        <img src="{{ asset('img/gens.jpg') }}" class="card-img-top rounded-top" alt="Gents">
                        <div class="card-body">
                            <h6 class="fw-semibold mb-3">Gents</h6>
                            <a href="#" class="btn btn-dark btn-sm px-4">View</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card border-0 shadow-sm h-100">
                        <img src="{{ asset('img/shoes.jpg') }}" class="card-img-top rounded-top" alt="Shoes">
                        <div class="card-body">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card border-0 shadow-sm h-100">
                        <img src="{{ asset('img/acces.jpg') }}" class="card-img-top rounded-top" alt="Accessories">
                        <div class="card-body">
                ...
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="card border-0 shadow-sm h-100">
                        <img src="{{ asset('img/kids.jpg') }}" class="card-img-top rounded-top" alt="Kids">
                        <div class="card-body">
                            <h6 class="fw-semibold mb-3">Kids</h6>
                            <a href="#" class="btn btn-dark btn-sm px-4">View</a>
                        </div>
                    </div>
                </div>
